              ...
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                  <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                    Sangat Miskin</div>
                  <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $kemiskinan_tinggi; ?></div>
                </div>
                <div class="col-auto">
              ...
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                  <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                    Miskin Menengah</div>
                  <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $kemiskinan_sedang; ?></div>
                </div>
                <div class="col-auto">
            ...
            <div class="card-body">
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                  <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                    Tidak Miskin</div>
                  <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $kemiskinan_rendah; ?></div>
                </div>
                <div class="col-auto">
