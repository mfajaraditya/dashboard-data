          ...
          <div class="content">
               <div class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                         <h1 class="h3 mb-0 text-gray-800">Grafik Total Data Kondisi Atap</h1>
                    </div>
                    <div class="row">
                                   ...
                                   <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                             <div class="col mr-2">
                                                  ...
                                                  Bagus/kualitas baik</div>
                                                  <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $kondisiAtap1; ?></div>
                                             </div>
                                             <div class="col-auto">
                              ...
                              <div class="card border-left-primary shadow h-100 py-2">
                                   <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                             <div class="col mr-2">
                                                  <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                  Jelek/kualitas rendah</div>
                                                  <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $kondisiAtap2; ?></div>
                                             </div>
                                             <div class="col-auto">
